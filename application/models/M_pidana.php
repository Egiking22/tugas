...
class M_pidana extends CI_Model
{

    public $table = 'jawal_persidanagn_pidana';
    public $id = 'no';
    public $order = 'DESC';
...
/* End of file M_pidana.php */
/* Location: ./application/models/M_pidana.php */
