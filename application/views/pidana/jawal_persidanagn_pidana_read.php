<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <h2 style="margin-top:0px">Jawal persidanagn pidana</h2>
        <table class="table">
	    ...
	    <tr><td>Jpu</td><td><?php echo $jpu; ?></td></tr>
	    <tr><td>Agenda</td><td><?php echo $agenda; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('pidana') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
        </div><!-- /.container-fluid -->
    </section>
    <!-- /.content -->
